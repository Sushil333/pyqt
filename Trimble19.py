...
config_file = os.getcwd() + "\\Trimble.config" 
...
class I18N():
    ...
    def resourceLanguageGerman(self):      
        ...
        self.enter_pickup_number = "EIngabe - Abholnummer"
        ...
        self.total_load = "Verladegewicht" 
...
"background-color: rgb(45, 45, 45);")
    ...
    def retranslateUi(self, ScanPickupNumber):
        ...
        self.label.setText(_translate("ScanPickupNumber", self.i18n.enter_pickup_number))
...
"background-color: rgb(45, 45, 45);")
        ...
        self.Button_dot = QtWidgets.QPushButton(EnterData)
        self.Button_dot.setGeometry(QtCore.QRect(640, 660, 41, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Button_dot.setFont(font)
        self.Button_dot.setStyleSheet("border: 1px solid black;\n"
...
"background-color: rgb(45, 45, 45);")
    ...
    def retranslateUi(self, EnterData):
        ...
        self.label_8.setText(_translate("EnterData", self.i18n.total_load + " (t)"))
        ...
        self.Button_dot.setText(_translate("EnterData", ","))
...
class Ui_EmptyWeighing(object):
    ...
    def enable_all(self, w_obj):
        ...
        _translate = QtCore.QCoreApplication.translate
        fweight = float(w_obj["weight"])/1000.0
        fweight_s = ("%6.3f"%(fweight)).replace('.',',')
        self.msg_label_2.setText(_translate("EmptyWeighing", "Gewicht: " + fweight_s + " t"))
...
class Ui_FullWeighing(object):
    ...
    def enable_all(self, w_obj):
        ...
        fweight = float(w_obj["weight"])/1000.0
        fweight_s = ("%6.3f"%(fweight)).replace('.',',')
        self.msg_label_2.setText(_translate("FullWeighing", "Gewicht: " + fweight_s + " t"))
        self.nextButton.show()
        self.backButton.show()
...
"border-radius: 25px;")
    ...
    def save(self, window): 
        ...
        #print("st_weight = %s, end_weight = %s"%(repr(st_weight), repr(end_weight)))
